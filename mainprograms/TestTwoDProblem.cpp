...
int main()
{
    GeoMesh gmesh;
    ReadGmsh read;
    std::string filename=("A_MalhaAnelTria.msh");;
    #ifdef MACOSX
    filename = "../"+filename;
    #endif
    // #ifdef MACOSX
...
//     std::string name_mesh1 ="trian_pro.msh";
//     std::string name_mesh2 ="quad.msh";
...
//        test.vtk_names.push_back("1MallaTri_func1_ordem1.vtk");
    ...
    //    test.exact_sols.push_back(exact1);
    //    test.forces.push_back(force1);
    //    test.vtk_names.push_back("1MallaTri_func1_ordem2.vtk");
    ...
    //    test.exact_sols.push_back(exact1);
    //    test.forces.push_back(force1);
    //    test.vtk_names.push_back("1MallaQuad_func1_ordem1.vtk");
    ...
    //    test.exact_sols.push_back(exact1);
    //    test.forces.push_back(force1);
    //    test.vtk_names.push_back("1MallaQuad_func1_ordem2.vtk");
    ...
    //    test.vtk_names.push_back("2MallaTri_func2_ordem1.vtk");
...
//         deriv(1,0) =2.*tempy*tempx*tempx;
//     };

//     bc_linha0->SetExactSolution(exact);
...
//     std::vector<MathStatement *> mathvec = {0,mat1,bc_linha0};
...
//     postprocess.SetExact(exact);
//     mat1->SetExactSolution(exact);
//     locAnalysis.PostProcessSolution("quadstest.vtk", postprocess);
